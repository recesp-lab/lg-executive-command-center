...
// Antes: este arquivo mantinha sua PRÓPRIA cópia de TeamMember e do array
// padrão de 16 membros, separada de data/teamData.ts - e o tipo de
// organização das duas cópias tinha ficado diferente (uma com RECRUT.AI,
// outra sem), o que quebrou o build do One Pager. Agora os dois lêem
// exatamente a mesma fonte.
import { loadTeamMembers, TEAM_STORAGE_KEY, type TeamMember } from '@/data/teamData';
